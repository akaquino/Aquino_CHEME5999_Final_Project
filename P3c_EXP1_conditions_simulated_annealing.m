...
Km1 = 1.02; %uM    
Km2 = 2*Km1; %uM
theta = ((Eo*x3_EXP1)^a)/(50*Eo*x3_EXP1 + (Eo*x3_EXP1)^a); 
...
value_initial= (x1_o.*F1)./(kcat_SA_0.*V_phase1) -  (x1_EXP1.*F4)./(kcat_SA_0.*V_phase1) - theta_SA_0.*(x1_EXP1./(Km1_SA_0 + x1_EXP1)).*(x2_EXP1./(Km2_SA_0 + x2_EXP1)) ...
        +(x2_o.*F2)./(kcat_SA_0.*V_phase1) -  (x2_EXP1.*F4)./(kcat_SA_0.*V_phase1) - theta_SA_0.*(x1_EXP1./(Km1_SA_0 + x1_EXP1)).*(x2_EXP1./(Km2_SA_0 + x2_EXP1)) ...
        +(x3_o.*F3)./(kcat_SA_0.*V_phase1) - (x3_EXP1.*F4)./(kcat_SA_0.*V_phase1) ...
        +(theta_SA_0.*(x1_EXP1./(Km1_SA_0 + x1_EXP1)).*(x2_EXP1./(Km2_SA_0 + x2_EXP1)) - (x4_EXP1.*F4)./(kcat_SA_0.*V_phase1));
...
value_final=(x1_o.*F1)./(kcat_SA_f.*V_phase1) -  (x1_EXP1.*F4)./(kcat_SA_f.*V_phase1) - theta_SA_f.*(x1_EXP1./(Km1_SA_f + x1_EXP1)).*(x2_EXP1./(Km2_SA_f + x2_EXP1)) ...
        +(x2_o.*F2)./(kcat_SA_f.*V_phase1) -  (x2_EXP1.*F4)./(kcat_SA_f.*V_phase1) - theta_SA_f.*(x1_EXP1./(Km1_SA_f + x1_EXP1)).*(x2_EXP1./(Km2_SA_f + x2_EXP1)) ...
        +(x3_o.*F3)./(kcat_SA_f.*V_phase1) - (x3_EXP1.*F4)./(kcat_SA_f.*V_phase1) ...
        +(theta_SA_f.*(x1_EXP1./(Km1_SA_f + x1_EXP1)).*(x2_EXP1./(Km2_SA_f + x2_EXP1)) - (x4_EXP1.*F4)./(kcat_SA_f.*V_phase1));
...
syms a_SA
eqn = ((Eo.*x3_EXP1).^a_SA)./(50.*Eo.*x3_EXP1 + (Eo.*x3_EXP1).^a_SA) == theta_SA;
